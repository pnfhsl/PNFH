...
const cerrarmodal = () => {
  ...
  $("#modalAgregarSeccion #tutor").val('').trigger('change');
  $("#modalAgregarSeccion #trayecto").val('').trigger('change');
  $("#modalAgregarSeccion #seccion").val('').trigger('change');
  $("#modalAgregarSeccion #alumnos").val('').trigger('change');
  $("#modalAgregarSeccion").modal('hide');
  $("#formAgregar #nombreS").html("");
  $("#formAgregar #trayectoS").html("");
  $("#formAgregar #seccionS").html("");
  $("#formAgregar #alumnosE").html("");
  $("#formAgregar #tutorS").html("");
}  
