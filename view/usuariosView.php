    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">
            <?php if (!empty($action)) { echo $action; } echo " " . $url; ?>
          </li>
        </ol>
      </section>
                        ...
                        <div class="modal-content">
                          <form role="form" method="post" id="formAgregar" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="salirM">Salir</button>
                    ...
                    <tbody>
                      ...
                      foreach ($usuarios as $data) :
                        if (!empty($data['cedula_usuario'])) :
                          $estado = "";
                          $estiloss = "";
                          if($data['estatusUser']=="0"){ $estado = "Inactivo"; $estiloss = "color:#999 !important"; }
                          else if($data['estatusUser']=="1"){ $estado = "Activo"; }
                          else if($data['estatusUser']=="2"){ $estado = "Primer Ingreso"; $estiloss = "background:#77AA0033"; }
                      ...
                      ?>
                          <tr style="<?=$estiloss;?>" >
                            ...
                            <?php if ($amUsuariosE == 1 || $amUsuariosB == 1) : ?>
                              <td style="width:10%">
                                <?php if($data['estatusUser']!="1" || $data['estatusUser']!="2"): ?>
                                  <?php if($data['estatusUser']=="1"): ?>
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <form role="form" method="post" id="formModificar" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group col-xs-12 col-sm-12">
                                                      ...
                                                      <div class="input-group" style="width:100%;">
                                                        ...
                                                        <select class="form-control input-lg rolModificar" style="width:100%;" name="<?=$data['cedula_usuario'] ?>" id="rol<?=$data['cedula_usuario'] ?>">
                                                          <option value="">Seleccionar rol</option>
                                                          <?php foreach ($roles as $rols) : if (!empty($rols['id_rol'])) : ?>
                                                              <option <?php if ($data['id_rol'] == $rols['id_rol']) {
                                                                        echo "selected";
                                                                      } ?> value="<?= $rols['id_rol'] ?>"><?= $rols['nombre_rol'] ?></option>
                                                          <?php endif;
                                                          endforeach; ?>
                                                        </select>
                                                      </div>
                                                        ...
                                                        <select class="form-control select2 input-lg cedulaModificar" style="width:100%;" name="<?=$data['cedula_usuario'] ?>" id="cedula<?=$data['cedula_usuario'] ?>">
                                                          ...
                                                          <?php foreach ($usuariosSelect as $users) : ?>
                                                            <?php if (!empty($users['codigo'])) : ?>
                                                              <option <?php if ($data['cedula_usuario'] == $users['codigo']) {
                                                                        echo "selected";
                                                                      } ?> value="<?= $users['codigo']; ?>">C.I. <?= $users['cedula'] . " " . $users['nombre'] . " " . $users['apellido']; ?></option>
                                                            <?php endif; ?>
                                                          <?php endforeach; ?>
                                                        </select>
                                                      </div>
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary modificarButtonModal" value="<?=$data['cedula_usuario'] ?>" id="modificar">Modificar</button>
                                              </div>
                                  ...
                                  <?php if($data['estatusUser']=="0"): ?>
                                    <button class="btn habilitarBtn" style="border:0;background:#DDD;color:#4AC;" value="<?php echo $data['cedula_usuario'] ?>">
                                      <span class="fa fa-trash"></span>
                                    </button>
                                  <?php endif; ?>
