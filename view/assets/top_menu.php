  ...
  <nav class="navbar navbar-static-top" style="background:#047 !important">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        <li>
          <a target="_blank" href="<?= _ROUTE_ ?>guide/Manual-de-usuario.pdf">
            <i class="glyphicon glyphicon-question-sign" style="font-size:1.2em"></i>
          </a>
        </li>
        <?php if ($_SESSION['cuenta_usuario']['estatus'] == "1") : ?>
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle box_notificaciones" data-toggle="dropdown">
              ...
              <span class="label cantidad_notificaciones" <?php if ($cantidadNoVistas > 0) { ?>  style="background:red"  <?php } ?> >
                 <?php
                  if ($cantidadNoVistas > 0) {
                    echo $cantidadNoVistas;
                  }
                ?>
              </span>
            </a>
            <ul class="dropdown-menu" class="notification">
              <!-- style="width:320px" -->
              ...
              <li>
                <ul class="menu menu_notificaciones">
                  <!-- style="width:400px" -->
                  <?php
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <?php
              ...
              $nameLong = false;
              if($nameLong){
                $nombreMostrar = $_SESSION['cuenta_persona']['nombre'];
                $apellidoMostrar = $_SESSION['cuenta_persona']['apellido'];
              }else{
                if($_SESSION['cuenta_persona']['nombreCorto'] != ""){
                  $nombreMostrar = $_SESSION['cuenta_persona']['nombreCorto'];
                }else{
                  $nombreMostrar = $_SESSION['cuenta_persona']['nombre'];
                }
                if($_SESSION['cuenta_persona']['apellidoCorto'] != ""){
                  $apellidoMostrar = $_SESSION['cuenta_persona']['apellidoCorto'];
                }else{
                  $apellidoMostrar = $_SESSION['cuenta_persona']['apellido'];
                }
              }
          ...
          <ul class="dropdown-menu" style="box-shadow:0px 0px 2px #000">
            <li class="user-header bg-primary" style="background-size:100% 100%;">
